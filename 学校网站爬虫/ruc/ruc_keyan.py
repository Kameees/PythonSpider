...
class TWT(object):
    ...
    def reqs(self, url_items, sum_num, num = 0):
        ...
        if res.status_code == 200:
            ...
            try:
                gs_con = con_et.xpath('.//div[@class="dynamic_list pb_list"]/ul/li')
    ...
    def gevent_down(self, url, item):
        ...
        try:
            ...
            nr_s = []
            A = 0
            p_s = dom_tree.xpath('.//div[@class="text_conment"]/p')[1:]
            for x in p_s:
                try:
    ...
    def find_one(self):
        ...
        #获取每一页的详情链接 存入mongo
        for sum_num, i in enumerate([['http://keyan.ruc.edu.cn/index.php?s=/Outside/Index/news_kydt/cid/60.html', 1306]]):
             self.reqs(i, sum_num)
