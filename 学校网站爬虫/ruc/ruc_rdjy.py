...
class TWT(object):
    ...
    def reqs(self, url_items, sum_num, num = 0):
        ...
        if res.status_code == 200:
            ...
            try:
                gs_con = con_et.xpath('.//div[@class="list-list"]')
    ...
    def gevent_down(self, url, item):
        ...
        try:
            ...
            nr_s = []
            A = 0
            p_s = dom_tree.xpath('.//div[@class="detail-txtfont"]/span/p')
            for x in p_s:
                try:
                    ...
                    try:
                        ...
                        img_list_one = urljoin(url, img_list_one)
                        try:
                            A += 1
                            if A == 1:
    ...
    def find_one(self):
        ...
        #获取每一页的详情链接 存入mongo
        for sum_num, i in enumerate([['http://rdjy.ruc.edu.cn/html/main/col11/column_11_1.html', 1266]]):
             self.reqs(i, sum_num)
