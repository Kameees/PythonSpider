...
class TWT(object):
    ...
    def reqs(self, url_items, sum_num, num = 0):
        ...
        if res.status_code == 200:
            ...
            try:
                gs_con = con_et.xpath('.//li[@class="media"]')
        ...
        try:
            ...
            for x in p_s:
                try:
                    ...
                    href_text = x.xpath('.//a/text()')[0]
                    if 'http' in href_text:
                        href_text = []
                    href_text = href_text.strip()
    ...
    def find_one(self):
        ...
        #获取每一页的详情链接 存入mongo
        for sum_num, i in enumerate([['http://www.oir.pku.edu.cn/xwzx/xwkd.htm', 1306], ['http://www.oir.pku.edu.cn/xwzx/ggtz.htm', 1305]]):
             self.reqs(i, sum_num)
